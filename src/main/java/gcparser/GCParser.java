...
public abstract class GCParser {
    ...
    public static final String full_gc_re = "\\[Full GC (\\(System\\) )?";
    ...
    public static final int heap_size_paren_re_groups = heap_size_re_groups;

    public static final String heap_size_change_re = heap_size_re + "->" + heap_size_re;
    public static final int heap_size_change_re_size_beg_group = heap_size_re_size_group;
    public static final int heap_size_change_re_unit_beg_group = heap_size_re_unit_group;
    public static final int heap_size_change_re_size_end_group = heap_size_re_groups + heap_size_re_size_group;
    public static final int heap_size_change_re_unit_end_group = heap_size_re_groups + heap_size_re_unit_group;
    public static final int heap_size_change_re_groups = heap_size_re_groups * 2;

    // 8K->4K(96K), or 8K->4K (96K)
    public static final String heap_size_status_re = heap_size_change_re + " ?" + heap_size_paren_re;

    public static final int heap_size_status_re_size_beg_group = heap_size_change_re_size_beg_group;
    public static final int heap_size_status_re_unit_beg_group = heap_size_change_re_unit_beg_group;
    public static final int heap_size_status_re_size_end_group = heap_size_change_re_size_end_group;
    public static final int heap_size_status_re_unit_end_group = heap_size_change_re_unit_end_group;
    public static final int heap_size_status_re_commit_size_group = heap_size_change_re_groups + heap_size_re_size_group;
    public static final int heap_size_status_re_commit_unit_group = heap_size_change_re_groups + heap_size_re_unit_group;
    public static final int heap_size_status_re_groups = heap_size_change_re_groups + heap_size_paren_re_groups;
    ...
    public static final int gc_time_secs_re_groups = gc_time_re_groups + 1;

    public static final String gc_time_ms_re = gc_time_re + " (ms)";
    public static final int gc_time_ms_re_groups = gc_time_re_groups + 1;

    public static final String timestamp_re = "(" + gc_time_re + ": *)?";
    public static final int timestamp_re_time_group = 2;
    public static final int timestamp_re_groups = gc_time_re_groups + 1;

    public static final String timestamp_range_re = "(" + gc_time_re + "-" + gc_time_re + ": *)?";
    public static final int timestamp_range_re_groups = gc_time_re_groups * 2 + 1;

    // Heap size status plus elapsed time:  8K->4K(96K), 0.0517089 secs
    public static final String heap_report_re = heap_size_status_re + ", " + gc_time_secs_re;
    public static final int heap_report_re_size_beg_group = heap_size_status_re_size_beg_group;
    public static final int heap_report_re_unit_beg_group = heap_size_status_re_unit_beg_group;
    public static final int heap_report_re_size_end_group = heap_size_status_re_size_end_group;
    public static final int heap_report_re_unit_end_group = heap_size_status_re_unit_end_group;
    public static final int heap_report_re_commit_size_group = heap_size_status_re_commit_size_group;
    public static final int heap_report_re_commit_unit_group = heap_size_status_re_commit_unit_group;
    public static final int heap_report_re_time_group = heap_size_status_re_groups + gc_time_secs_re_time_group;
    public static final int heap_report_re_groups = heap_size_status_re_groups + gc_time_secs_re_groups;

    // Size printed at CMS initial mark and remark.
    public static final String cms_heap_size_re = heap_size_re + heap_size_paren_re;
    public static final int cms_heap_size_re_groups = heap_size_re_groups + heap_size_paren_re_groups;

    public static final String cms_heap_report_re = cms_heap_size_re + ", " + gc_time_secs_re;
    public static final int cms_heap_report_re_groups = cms_heap_size_re_groups + gc_time_secs_re_groups;

    public static final String cms_concurrent_phase_name_re = "(AS)?CMS-concurrent-(mark|(abortable-)?preclean|sweep|reset)";
    ...
    public static final String promo_failed_re = "(--| \\(promotion failed\\))?";
    public static final int promo_failed_re_groups = 1;
    public static final String pargc_young_gc_re = "\\[GC" + promo_failed_re + " ";
    public static final int pargc_young_gc_re_groups = promo_failed_re_groups;

    public static final String cms_gen_re = "(AS)?CMS( \\(concurrent mode failure\\))?";
    public static final int cms_gen_re_groups = 2;
    public static final String cms_perm_gen_re = "CMS Perm";
    public static final int cms_perm_gen_re_groups = 0;

    // 'Framework' GCs:  DefNew, ParNew, Tenured, CMS
    public static final String fw_young_gen_re = "(DefNew|(AS)?ParNew)" + promo_failed_re;
    public static final int fw_young_gen_re_groups = 2 + promo_failed_re_groups;

    public static final String fw_old_gen_re = "(Tenured|" + cms_gen_re + ")";
    public static final int fw_old_gen_re_groups = 1 + cms_gen_re_groups;
    public static final String fw_perm_gen_re = "(Perm|" + cms_perm_gen_re + ")";
    public static final int fw_perm_gen_re_groups = 1 + cms_perm_gen_re_groups;
    ...
    public static final String g1_cleanup_re = "cleanup " + heap_size_status_re;
    public static final String g1_pause_re = "pause \\((young|partial)\\)" + "( \\((initial-mark|evacuation failed)\\))?";
    public static final String g1_stw_re = "\\[GC (" + g1_pause_re + "|remark|" + g1_cleanup_re + "), " + gc_time_secs_re + "\\]";
    ...
    public GCParser(GCStats gcstats, boolean verbose, PrintStream vstream) {
        if (verbose && vstream == null) {
            throw new IllegalArgumentException("null vstream when verbose == true");
        }
        _gcstats = gcstats;
        _verbose = verbose;
        _vstream = vstream;
...
// 	}
    ...
    protected double young_gc_amount_allocated(double yg_used_beg,
        ...
        debug("unable to compute amount allocated");
        debug();
        return 0.0;
    }
...
// 	}
    ...
    protected void debug() {
        if (_debug != null) _debug.println();
    }

    protected void debug(String s) {
        if (_debug != null) _debug.print(s);
    }
